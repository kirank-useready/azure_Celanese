...
function Svganimation() {
  ...
  const url = `${Config.host}`+"productionUnit";
  console.log("url-->",url);
...
Model" transform="translate(82 323)" fill="#1d95c5" fontSize="24" fontWeight="600" fontStyle="italic"><tspan x="0" y="0">Manufacturing Operating </tspan><tspan x="0" y="24">Model</tspan></text>
        ...
        <div className="right-side">
          {
             <>
              <div className={!childTogglename.isActivecoreteam && !childTogglename.isActiveunit && !childTogglename.isActivecorpoteam && !childTogglename.isActivemanufservice && !childTogglename.isActive ? "show":"hide"}>
                <div className="scrollerdivchart">
                  <h4>Production Unit Feed Rate</h4>
				  {
				  productionUnitData.length > 1 ? (
				  <>
				  <Vam productionUnitData={productionUnitData}> </Vam>
                  <Meoh productionUnitData={productionUnitData}> </Meoh>
                  <Aas productionUnitData={productionUnitData}> </Aas>
                  <Eo productionUnitData={productionUnitData}></Eo>
                  <Eg1 productionUnitData={productionUnitData}></Eg1>
                  <Eg2 productionUnitData={productionUnitData}></Eg2>
				  </>
				  ): <div className="loaderDiv"><span className="loader-img"> </span> </div>
                  }
                </div>
                <SquareBackground></SquareBackground>
              </div> 
                  <div className={svgToggle.twentysevenSvg ? "show":"hide"}>
...

          {
              ...
              <div className={svgToggle.unitteamSvg ? "show": "hide"}>
                <div className="scrollerdiv">
                  <h4>Unit Team</h4>
                  <ul>
          ...
          }
          {
              ...
              <div className={svgToggle.coreteamSvg ? "show":"hide"}>
                <div className="scrollerdiv">
                  <h4>Core Team</h4>
                  <ul>
...

          {
              ...
              <div className={svgToggle.manufservicesSvg ? "show":"hide"}>
                <div className="scrollerdiv">
...

          {
              ...
              <div className={svgToggle.corporateSvg ? "show":"hide"}>
                <div className="scrollerdiv">
                  <h4>Corporate</h4>
                  <ul>
