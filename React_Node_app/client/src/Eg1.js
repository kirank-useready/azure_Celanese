...
function Eg1(props) {
  ...
  const [vaseries,setvaseries] = useState([ { name: 'Eg1', data: [] }])
 ...
 const getChartData = () => {
   ...
   for (let i=0; i < datas.length;i++){
	 seriesdata.push(parseFloat(datas[i].EG1).toFixed(1));
  ...
  let updateseries = { name: 'Eg1', data: [...seriesdata] };
...
<div id="chart" className="haciichart">
 ...
 <div>
  <div className="left-float">EG1<p></p></div>  
