...
function Eo(props) {
  ...
  const [vaseries,setvaseries] = useState([ { name: 'EO', data: [] }])
 ...
 const getChartData = () => {
   ...
   for (let i=0; i < datas.length;i++){
	 seriesdata.push(parseFloat(datas[i].EO).toFixed(1));
  ...
  let updateseries = { name: 'EO', data: [...seriesdata] };
...
<div id="chart" className="haciichart">
 ...
 <div>
  <div className="left-float">EO<p></p></div>  
